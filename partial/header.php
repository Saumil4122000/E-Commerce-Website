            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="c_form.php" class="flex-c-m trans-04 p-lr-25">
                            Log In
                        </a>
                        <?php    }
                        else { ?>
                        <a href="c_logout.php" class="flex-c-m trans-04 p-lr-25">
                            Log Out
                        </a>
                        <?php }?>
        ...
        <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
            <div class="container-search-header">
                ...
                <form class="wrap-search-header flex-w p-l-15">
                    ...
                    <input class="plh3" type="text" name="search" data-filter=".22" placeholder="Search...">
                </form>
            </div>
        </div>
    </header>
        ...
        <div class="header-cart flex-col-l p-l-65 p-r-25">
            ...
            <div class="table-responsive-sm" >
                ...
                <table class="table">
								...
								<tr>
                                    <td class="column-1"><?php echo $no_of_item ?></td>
